...
// RequestOption is an option for the requests made by the taam-cloud API Client
// which can be supplied to clients, services, and methods. You can read more about this functional
// options pattern in our [README].
//
// [README]: https://pkg.go.dev/github.com/taamsoftadmin/taam-cloud-go-sdk#readme-requestoptions
...
func WithEnvironmentProduction() RequestOption {
	return WithBaseURL("https://newapi.taam.cloud/")
}
...
func WithEnvironmentEnvironment1() RequestOption {
	return WithBaseURL("https://uploud.taam.cloud/")
}
...
func WithEnvironmentEnvironment2() RequestOption {
	return WithBaseURL("https://crawl.taam.cloud/")
}

// WithEnvironmentEnvironment3 returns a RequestOption that sets the current
// environment to be the "environment_3" environment. An environment specifies which base URL
// to use by default.
func WithEnvironmentEnvironment3() RequestOption {
	return WithBaseURL("https://apisearch.taam.cloud/")
}
