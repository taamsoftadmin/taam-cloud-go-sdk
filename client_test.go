...
func TestRetryAfter(t *testing.T) {
	...
	res, err := client.Embeddings.New(context.Background(), taamcloud.EmbeddingNewParams{
		Input: taamcloud.F([]string{"string"}),
		Model: taamcloud.F("jina-embeddings-v3"),
	})
	if err == nil || res != nil {
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	res, err := client.Embeddings.New(cancelCtx, taamcloud.EmbeddingNewParams{
		Input: taamcloud.F([]string{"string"}),
		Model: taamcloud.F("jina-embeddings-v3"),
	})
	if err == nil || res != nil {
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		res, err := client.Embeddings.New(deadlineCtx, taamcloud.EmbeddingNewParams{
			Input: taamcloud.F([]string{"string"}),
			Model: taamcloud.F("jina-embeddings-v3"),
		})
		if err == nil || res != nil {
